  ...
  Board: () => (
    <Doc>
        ...
        description={
          <div>
            <ul>
              ...
              <li>
                <code>currency</code> – Currency symbol to be displayed in UI
              </li>
              <li>
                <code>amount</code> – Will be formatted according to number
                format, e.g. <code>1000</code> will be displayed as{" "}
                <code>1,000.00</code>
              </li>
            </ul>
          </div>
      ...
      <DocSection
        ...
        description={
          <div>
            Use emphasized <code>CardsDetail</code> to create hierarchy
            <ol>
              <li>
        ...
        contentLayout="grid3"
      >
        <CardsDetail label="Income" currency="$" amount={1300.0} emphasized />
