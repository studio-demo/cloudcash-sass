  ...
  Board: () => {
    return (
      <Doc>
        ...
        >
          <Button className={styles.customButtonColor}>Call to Action</Button>
          <Button className={styles.customButtonShape}>Call to Action</Button>
          <Button className={styles.customButtonStyle}>Call to Action</Button>
        </DocSection>
      </Doc>
    );
  },
